...
public class Flat implements Comparable<Flat> {
    ...
    /**
     * Method getUser_id() for get Integer user_id value
     * @return Integer number
     */
    ...
    /**
     * Method setUser_id() for set Integer user_id value
     * @param user_id
     */
     ...
     * @param x
     */
    public void setCoordinatesX(Long x){
        coordinates.setX(x);
    }
    /**
    ...
    /**
     * Method setCreationDate() for set LocalDateTime object to the Float object from Date object
     * @param date
     */
    public void setCreationDate(Date date) {
        this.creationDate = new Timestamp(date.getTime()).toLocalDateTime();
    }
    /**
     * Method setCreationDate() for set LocalDateTime object to the Float object from LocalDateTime object
     * @param creationDate
     */
